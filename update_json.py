...
def main():
    input_folder = '/home/ybourennane/blenderProc/BlenderProc/blenderproc/scripts/output'
    output_folder = '/home/ybourennane/blenderProc/BlenderProc/blenderproc/scripts/output_json_updated'
    ...
    for filename in os.listdir(input_folder):
        if filename.endswith('.json'):
            ...
            base_name = pattern.split('_')[0] + '_' + pattern.split('_')[1] 
            pattern1 = base_name + ".obj"
            # pattern1 = "apple_88.obj"
